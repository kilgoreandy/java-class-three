...
/**
* Create a default constructor (no parameters) that assigns all your instance 
variables to default values  (1 points)
 */
...
/**
 * Create a parameterized constructor that takes all instance variables as 
parameters, and sets the instance variables to the values provided by the 
parameters (2 points)
 */
...
instance variables of your object (2 points)
     */
    public void display(){
    System.out.println("Chicken Name: " + this.chickenName + ", Number of Fingers: 
" + this.amount + ", Weight: " + this.weight + "lbs");
}
 /**
  *  Create any other method of your choice that increments or decrements any one 
of the objects instance fields. Test out the method
  *  for at least one of your objects. (2 point)
  */

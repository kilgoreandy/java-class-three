...
public static void main(String[] args) {
    ...
    // loop throught the array and call each objects display function. After each item is displayed secretly feed the chicken. 
    ...
    // loop through and redisplay the updated objects stats since the chicken has ate.
    for (Chicken_Fingers i : flock){
        i.display();
    }
}
